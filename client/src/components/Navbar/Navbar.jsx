      ...
      <nav className="navbar">
        ...
        {/* MENU */}
        {
          <div className={isOpen ? "newnav-menu" : "newnav-menu-closed"}>
              ...
              <ul className={!isOpen ? "hidden" : "visable"}>
                ...
                <li hidden={loggedIn}>
                  <button
                    className="nav-btn"
                    onClick={() => {
                      handleNavigation("/"), setOpen(!isOpen);
                    }}
                  >
                    Log In
                  </button>
            ...
            <div className="open-area" onClick={handleOpenArea}></div>
          </div>
        }
        ...
        <div className="nav-profilePicture">
          <button
            className="nav-picture-button"
            onClick={() => setProfileDetails(!profiledetails)}
          >
            <img
              src={loggedIn ? loggedIn.profile_picture : generic}
              alt=""
        ...
        <div className="nav-profile-details" hidden={!profiledetails}>
          <div className="open-area-2" onClick={handleOpenArea}></div>
          {/* Logged In Version */}
          {loggedIn && (
            <div>
